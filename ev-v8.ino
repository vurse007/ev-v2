...
PID heading_corrector(2.1, 0, 400);
PID distance_corrector(0.0045, 0.0, 0);  // Tune these gains for your robot
...
const int SETTLED_COUNT_THRESHOLD = 2;        // How many consecutive loops within threshold
