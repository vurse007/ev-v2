...
void loop() {
    ...
    if (digitalRead(GO) == LOW) {
      ...
      driveDistanceMeters(0.825, 1000, 1);
      delay(50);
      ...
      turnToAngle(0 + 0.0299066,turnTimeout,turnScale);
      delay(50);

      driveDistanceMeters(9 - 0.15, driveTimeout, driveScale); // 9.1 too much
      delay(5);


      turnToAngle(PI/2 + 0.0523599,turnTimeout,turnScale);
