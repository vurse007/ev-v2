...
PID heading_corrector(0.2, 0, 100);
...
const double TARGET_DISTANCE = 450.0;  // Adjust this value for desired distance
...
void loop() {
  ...
  if (motorRunning) {
    ...
    double leftSpeed = constrain(baseSpeed + headingCorrection, 0, 0.7);
    double rightSpeed = constrain(baseSpeed - headingCorrection, 0, 0.7);
