...
//     const double ENCODER_CPR = 13.75;           // counts per revolution // 14
...
// PID heading_corrector(0.1, 0, 400);
// PID distance_corrector(0.0037, 0.0, 300);  // Tune these gains for your robot
...
// const double TARGET_DISTANCE = metersToTicks(7);  // Adjust this value for desired distance
// const double MIN_BASE_SPEED = -0.2;      // Minimum speed to keep robot moving
// const double MAX_BASE_SPEED = 0.6;      // Maximum speed
